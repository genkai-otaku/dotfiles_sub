# Generated by Powerlevel10k configuration wizard on 2025-12-04 at 08:52 JST.
...
() {
  ...
  #   typeset -g POWERLEVEL9K_DIR_WORK_ANCHOR_FOREGROUND=135
  #
  ...
  #   typeset -g POWERLEVEL9K_DIR_WORK_NOT_WRITABLE_ANCHOR_FOREGROUND=135
  #
  ...
  # ステージング済み：赤、未ステージング：黄色、クリーン：緑
  typeset -g POWERLEVEL9K_VCS_STAGED_BACKGROUND=1
  typeset -g POWERLEVEL9K_VCS_UNSTAGED_BACKGROUND=3
  ...
  function my_git_formatter() {
    ...
    local       meta='%F{15}' # bright white foreground (unified)
    local      clean='%F{15}' # bright white foreground (unified)
    local   modified='%F{15}' # bright white foreground (unified)
    local  untracked='%F{15}' # bright white foreground (unified)
    local conflicted='%F{15}' # bright white foreground (unified)
  ...
  ###########[ timewarrior: timewarrior tracking status (https://timewarrior.net/) ]############
  # Timewarrior color.
  typeset -g POWERLEVEL9K_TIMEWARRIOR_FOREGROUND=135
  ...
  #######################[ go_version: go version (https://golang.org) ]########################
  # Go version color.
  typeset -g POWERLEVEL9K_GO_VERSION_FOREGROUND=135
...
############################################
# Custom VCS colors — 状態に応じた背景色 / 統一白文字(15)
############################################
# VCS_BACKGROUNDとVCS_BRANCH_BACKGROUNDは削除
# （各状態の背景色が優先されるように）

# 文字色の設定
typeset -g POWERLEVEL9K_VCS_FOREGROUND=15
typeset -g POWERLEVEL9K_VCS_BRANCH_FOREGROUND=15
typeset -g POWERLEVEL9K_VCS_BRANCH_ICON_FOREGROUND=15

# ステータス部の背景色設定
# ステージング済み：赤（1）
typeset -g POWERLEVEL9K_VCS_STAGED_BACKGROUND=1
typeset -g POWERLEVEL9K_VCS_STAGED_FOREGROUND=15

# 未ステージング：黄色（3）
typeset -g POWERLEVEL9K_VCS_UNSTAGED_BACKGROUND=3
typeset -g POWERLEVEL9K_VCS_UNSTAGED_FOREGROUND=15
